...
/* package abstraction-patterns-0.1.0.0 */
#ifndef VERSION_abstraction_patterns
#define VERSION_abstraction_patterns "0.1.0.0"
#endif /* VERSION_abstraction_patterns */
#ifndef MIN_VERSION_abstraction_patterns
#define MIN_VERSION_abstraction_patterns(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_abstraction_patterns */
...
#define CURRENT_PACKAGE_KEY "abstraction-patterns-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "abstraction-patterns-0.1.0.0-inplace"
